...
// マクロ定義
//*****************************************************************************
#define	TEXTURE_BILLBOARD		"data/TEXTURE/san.png"	// 読み込むテクスチャファイル名
#define	BILLBOARD_SIZE_X		(50.0f)							// ビルボードの幅
#define	BILLBOARD_SIZE_Y		(50.0f)							// ビルボードの高さ
